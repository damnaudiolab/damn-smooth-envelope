...
public:
    ...
    {
        static auto typeface = juce::Typeface::createSystemTypefaceFor (BinaryData::BarlowRegular_ttf, BinaryData::BarlowRegular_ttfSize);
    ...
    void drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height, float sliderPos, float rotaryStartAngle, float rotaryEndAngle, juce::Slider&) override
    {
        ...
        g.strokePath (pointer, juce::PathStrokeType (lineW * 0.5f, juce::PathStrokeType::curved, juce::PathStrokeType::rounded));
    }
    ...
    virtual juce::Label* createSliderTextBox (juce::Slider& slider) override
    {
        ...
        l->setColour (juce::Label::backgroundWhenEditingColourId, colourPalette[grey]);
        return l;
    }
